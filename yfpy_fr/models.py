...
from yfpy_fr.utils import jsonify_data

# from yfpy_fr.utils import flatten_to_objects
...
class YahooFantasyObject(object):
    ...
    ## MADE CHANGES
    ## Added a condition to handle team_stats attribute specifically
    def __getattribute__(self, attribute_name: str):
        ...
        if not attribute_name.startswith("_") and isinstance(attribute, (list, dict)):
            if attribute:
                ...
                ## Added a condition to handle team_stats attribute specifically
                elif attribute_name == "team_stats":
                    return attribute
...
class Team(YahooFantasyObject):
    ...
    def __init__(self, extracted_data):
        ...
        ## MADE CHANGES 
        ## Added the attribute(s) below
        self.team_stats: dict = self._get_nested_value(self._extracted_data, ["team_stats","stats"])
